...
<html lang="en">
  <head>
    ...
    <title>Servicio al Cliente | Home :: Monteverde - Servicios Ambientales y Forestales</title>
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <h2 class="monteverde-username">username</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					...
					<mv:item class="monteverde-username">username</mv:item>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="javascript: Mv.logout(true);"><i class="fa fa-sign-out pull-right"></i> Salir</a></li>
                  </ul>
                </li>
